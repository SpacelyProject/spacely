...
GLOBALS_TO_PICKLE = [ "ARDUINO_CONNECTED", "NI_CONNECTED", "AWG_CONNECTED", "VERBOSE", "PROGRESS", "USE_ARDUINO", "USE_NI", "USE_COCOTB", "SIMULATOR", "HDL_TOP_MODULE", "HDL_SOURCES", "FW_TOP_MODULE", "TWIN_MODE", "COCOTB_BUILD_ARGS", "TARGET", "TARGET_CONFIG_PY", "TARGET_ROUTINES_PY", "TARGET_SUBROUTINES_PY", "TARGET_CONFIG_MOD", "TARGET_ROUTINES_MOD", "TARGET_SUBROUTINES_MOD"]
