 ...
 */
 ...
 /* Some comments added by Adam Quinn, 10/19/2022
 */
#include "GPIO_user.h"
...
int GPIO_Config(unsigned long mask, unsigned long odMask)
{
	...
	//For each pin in the pin table, configure it as an output if the corresponding
	//bit in "mask" is 1, and as an input if the corresponding bit in "mask" is 0.
